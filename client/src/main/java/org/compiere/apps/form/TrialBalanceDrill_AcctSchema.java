 ...
 */
public class TrialBalanceDrill_AcctSchema
{

	/** Logger */
	public static CLogger			log						= CLogger.getCLogger(TrialBalanceDrill_AcctSchema.class);
	...
	protected void dynInit() throws Exception
	{
		...
		c_AcctSchema_ID = DB.getSQLValue(null, "SELECT MAX(C_AcctSchema_ID) FROM C_AcctSchema WHERE AD_CLient_ID=? AND isactive='Y'", m_AD_Client_ID);
